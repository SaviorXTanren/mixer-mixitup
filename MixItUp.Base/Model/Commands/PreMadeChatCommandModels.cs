...
//        public PreMadeChatCommandSettings(PreMadeChatCommandModel command)
//        {
...
//    public class PreMadeChatCommandModel : ChatCommandModel
//    {
//        public PreMadeChatCommandModel(string name, string trigger, int cooldown, UserRoleEnum role) : this(name, new HashSet<string>() { trigger }, cooldown, role) { }

//        public PreMadeChatCommandModel(string name, HashSet<string> triggers, int cooldown, UserRoleEnum role)
