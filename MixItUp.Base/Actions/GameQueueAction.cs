        ...
        protected override async Task PerformInternal(UserViewModel user, IEnumerable<string> arguments)
        {
            if (ChannelSession.Chat != null)
            {
                ...
                if (ChannelSession.Settings.GameQueueMinimumRank != null)
                {
                    ...
                    if (rankData.Currency.Enabled && rankData.Amount < ChannelSession.Settings.GameQueueMinimumRank.RequiredRank.MinimumPoints)
                    {
                ...
                if (ChannelSession.Settings.GameQueueCurrencyCost != null)
                {
                    ...
                    if (currencyData.Currency.Enabled && currencyData.Amount < ChannelSession.Settings.GameQueueCurrencyCost.RequiredAmount)
                    {
