...
namespace MixItUp.Base.Services.External
{
    ...
    {
        public IReadOnlyDictionary<string, FrankerFaceZEmoteModel> FrankerFaceZEmotes { get { return this.frankerFaceZEmotes; } }
        private ConcurrentDictionary<string, FrankerFaceZEmoteModel> frankerFaceZEmotes = new ConcurrentDictionary<string, FrankerFaceZEmoteModel>();
        ...
        public async Task DownloadChannelFrankerFaceZEmotes(string channelName) { await this.DownloadFrankerFaceZEmotes("https://api.frankerfacez.com/v1/room/" + channelName); }
