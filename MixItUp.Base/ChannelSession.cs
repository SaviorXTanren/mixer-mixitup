            ...
            try
            {
                ...
                if (twitchChannelNew != null && twitchChannelv5 != null)
                {
                    ...
                    try
                    {
                        ...
                        if (ChannelSession.Settings.PixelChatOAuthToken != null) { externalServiceToConnect[ChannelSession.Services.VTubeStudio] = ChannelSession.Settings.VTubeStudioOAuthToken; }
