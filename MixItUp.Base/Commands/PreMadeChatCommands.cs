...
namespace MixItUp.Base.Commands
{
    ...
    public class CommandsChatCommand : PreMadeChatCommand
    {
        public CommandsChatCommand()
            : base("Commands", "commands", 0, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    ...
                    if (commandTriggers.Count > 0)
                    {
                        ...
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, text);
                    }
                    else
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "There are no commands available for you to use.");
                    }
                }
            }));
        }
    ...
    public class GamesChatCommand : PreMadeChatCommand
    {
        public GamesChatCommand()
            : base("Games", "games", 0, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    ...
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "There are no games available for you to use.");
                    }
                }
            }));
        }
    ...
    public class MixItUpCommandsChatCommand : PreMadeChatCommand
    {
        public MixItUpCommandsChatCommand()
            : base("Mix It Up Commands", "mixitupcommands", 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class GameChatCommand : PreMadeChatCommand
    {
        public GameChatCommand()
            : base("Game", new List<string>() { "game" }, 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class TitleChatCommand : PreMadeChatCommand
    {
        public TitleChatCommand()
            : base("Title", new List<string>() { "title", "stream" }, 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class UptimeChatCommand : PreMadeChatCommand
    {
        ...
        public UptimeChatCommand()
            : base("Uptime", "uptime", 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class CostreamChatCommand : PreMadeChatCommand
    {
        ...
        public CostreamChatCommand()
            : base("Costream", "costream", 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class MixerAgeChatCommand : PreMadeChatCommand
    {
        public MixerAgeChatCommand()
            : base("Mixer Age", "mixerage", 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    ...
                    await ChannelSession.Services.Chat.SendMessage(user.MixerUsername + "'s Mixer Age: " + user.MixerAgeString);
                }
            }));
        }
    }
    ...
    public class FollowAgeChatCommand : PreMadeChatCommand
    {
        public FollowAgeChatCommand()
            : base("Follow Age", "followage", 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    await user.RefreshDetails();
                    await ChannelSession.Services.Chat.SendMessage(user.MixerUsername + "'s Follow Age: " + user.MixerFollowAgeString);
                }
            }));
        }
    }
    ...
    public class SubscribeAgeChatCommand : PreMadeChatCommand
    {
        public SubscribeAgeChatCommand()
            : base("Subscribe Age", new List<string>() { "subage", "subscribeage" }, 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    await user.RefreshDetails();
                    await ChannelSession.Services.Chat.SendMessage(user.MixerUsername + "'s Subscribe Age: " + user.MixerSubscribeAgeString);
                }
            }));
        }
    }
    ...
    public class StreamerAgeChatCommand : PreMadeChatCommand
    {
        public StreamerAgeChatCommand()
            : base("Streamer Age", new List<string>() { "streamerage", "age" }, 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    await user.RefreshDetails();
                    await ChannelSession.Services.Chat.SendMessage(user.MixerUsername + "'s Streamer Age: " + user.MixerAgeString);
                }
            }));
        }
    }
    ...
    public class SparksChatCommand : PreMadeChatCommand
    {
        public SparksChatCommand()
            : base("Sparks", "sparks", 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class QuoteChatCommand : PreMadeChatCommand
    {
        public QuoteChatCommand()
            : base("Quote", new List<string>() { "quote", "quotes" }, 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                    ...
                    if (ChannelSession.Settings.QuotesEnabled)
                    {
                        if (ChannelSession.Settings.Quotes.Count > 0)
                        {
                            ...
                            if (arguments.Count() == 1)
                            {
                                ...
                                {
                                    await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "USAGE: !quote [QUOTE NUMBER]");
                                    return;
                                }
                                ...
                                if (quoteIndex < 0)
                                {
                                    await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Quote # must be greater than 0");
                                    return;
                                }
    ...
    public class LastQuoteChatCommand : PreMadeChatCommand
    {
        public LastQuoteChatCommand()
            : base("Last Quote", new List<string>() { "lastquote" }, 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class AddQuoteChatCommand : PreMadeChatCommand
    {
        public AddQuoteChatCommand()
            : base("Add Quote", new List<string>() { "addquote", "quoteadd" }, 5, UserRoleEnum.Mod)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Settings.QuotesEnabled)
                {
                    ...
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Usage: !addquote <FULL QUOTE TEXT>");
                    }
                }
                else
                {
    ...
    public class Magic8BallChatCommand : PreMadeChatCommand
    {
        ...
        public Magic8BallChatCommand()
            : base("Magic 8 Ball", new List<string>() { "magic8ball", "8ball" }, 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class XboxGameChatCommand : PreMadeChatCommand
    {
        ...
        public XboxGameChatCommand()
            : base("Xbox Game", new List<string>() { "xboxgame" }, 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class SteamGameChatCommand : PreMadeChatCommand
    {
        ...
        public SteamGameChatCommand()
            : base("Steam Game", new List<string>() { "steamgame", "steam" }, 5, UserRoleEnum.User)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
    ...
    public class SetTitleChatCommand : PreMadeChatCommand
    {
        ...
        public SetTitleChatCommand()
            : base("Set Title", "settitle", 5, UserRoleEnum.Mod)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    ...
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Usage: !settitle <TITLE NAME>");
                    }
                }
            }));
        }
    ...
    public class SetGameChatCommand : PreMadeChatCommand
    {
        public SetGameChatCommand()
            : base("Set Game", "setgame", 5, UserRoleEnum.Mod)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    if (arguments.Count() > 0)
                    {
                        ...
                        if (newGame != null)
                        {
                            ...
                            await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Game Updated: " + newGame.name);
                        }
                        else
                        {
                            await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "We could not find a game with that name/ID");
                        }
                    }
                    else
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Usage: !setgame <GAME NAME>");
                    }
                }
            }));
        }
    ...
    public class SetAudienceChatCommand : PreMadeChatCommand
    {
        ...
        public SetAudienceChatCommand()
            : base("Set Audience", "setaudience", 5, UserRoleEnum.Mod)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    ...
                    await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Usage: !setaudience family|teen|adult");
                }
            }));
        }
    }
    ...
    public class SetUserTitleChatCommand : PreMadeChatCommand
    {
        public SetUserTitleChatCommand()
            : base("Set User Title", "setusertitle", 5, UserRoleEnum.Mod)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    if (arguments.Count() > 1)
                    {
                        ...
                        {
                            await ChannelSession.Services.Chat.Whisper(user.MixerUsername, username + " is not a valid user");
                        }
                    }
                    else
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Usage: !settitle <USERNAME> <TITLE NAME>");
                    }
                }
            }));
        }
    ...
    public class AddCommandChatCommand : PreMadeChatCommand
    {
        public AddCommandChatCommand()
            : base("Add Command", new List<string>() { "addcommand" }, 5, UserRoleEnum.Mod)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (arguments.Count() >= 3)
                {
                    ...
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "ERROR: Command trigger contain an invalid character");
                        return;
                    }
                    ...
                    foreach (PermissionsCommandBase command in ChannelSession.AllEnabledChatCommands)
                    {
                        if (command.IsEnabled)
                        {
                            ...
                            {
                                await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "ERROR: There already exists an enabled, chat command that uses the command trigger you have specified");
                                return;
                            }
                        }
                    }
                    ...
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "ERROR: Cooldown must be 0 or greater");
                        return;
                    }
                ...
                {
                    await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Usage: !addcommand <COMMAND TRIGGER, NO !> <COOLDOWN> <FULL COMMAND MESSAGE TEXT>");
                }
            }));
        }
    }
    ...
    public class UpdateCommandChatCommand : PreMadeChatCommand
    {
        public UpdateCommandChatCommand()
            : base("Update Command", new List<string>() { "updatecommand" }, 5, UserRoleEnum.Mod)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (arguments.Count() >= 2)
                {
                    ...
                    if (command == null)
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "ERROR: Could not find any command with that trigger");
                        return;
                    }
                ...
                {
                    await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Usage: !updatecommand <COMMAND TRIGGER, NO !> <COOLDOWN> [OPTIONAL FULL COMMAND MESSAGE TEXT]");
                }
            }));
        }
    }
    ...
    public class DisableCommandChatCommand : PreMadeChatCommand
    {
        public DisableCommandChatCommand()
            : base("Disable Command", new List<string>() { "disablecommand" }, 5, UserRoleEnum.Mod)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (arguments.Count() == 1)
                ...
                {
                    await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Usage: !disablecommand <COMMAND TRIGGER, NO !>");
                }
            }));
        }
    }
    ...
    public class StartGiveawayChatCommand : PreMadeChatCommand
    {
        public StartGiveawayChatCommand()
            : base("Start Giveaway", "startgiveaway", 5, UserRoleEnum.Streamer)
        {
            this.Actions.Add(new CustomAction(async (UserViewModel user, IEnumerable<string> arguments) =>
            {
                if (ChannelSession.Services.Chat != null)
                {
                    if (arguments.Count() > 0)
                    {
                        ...
                        {
                            await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "ERROR: " + result);
                        }
                    }
                    else
                    {
                        await ChannelSession.Services.Chat.Whisper(user.MixerUsername, "Usage: !startgiveaway <GIVEAWAY ITEM>");
                    }
                }
            }));
        }
