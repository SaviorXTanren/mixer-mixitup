    ...
    public class OverlayChatMessagesListItemViewModel : OverlayListItemViewModelBase
    {
        ...
        public override OverlayItemModelBase GetOverlayItem()
        {
            if (this.Validate())
            {
                ...
                return new OverlayChatMessagesListItemModel(this.HTML, totalToShow, fadeOut, this.Font, this.width, this.height, this.BorderColor, this.BackgroundColor, this.TextColor, this.entranceAnimation, this.exitAnimation);
            }
            return null;
        }
    }
