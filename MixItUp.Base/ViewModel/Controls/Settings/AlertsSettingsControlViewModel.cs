...
namespace MixItUp.Base.ViewModel.Controls.Settings
{
    public class AlertsSettingsControlViewModel : UIViewModelBase
    {
        ...
        public AlertsSettingsControlViewModel()
        {
            ...
            this.Sub = new GenericToggleColorComboBoxSettingsControlViewModel(MixItUp.Base.Resources.ShowSubs, ChannelSession.Settings.AlertSubColor, (value) => { ChannelSession.Settings.AlertSubColor = value; });
