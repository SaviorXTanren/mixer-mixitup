...
{
    public class HeistGameControlViewModel : GamesControlViewModelBase
    {
        ...
        public HeistGameControlViewModel(UserCurrencyViewModel currency)
        {
        ...
        public HeistGameControlViewModel(HeistGameCommand command)
        {
