...
{
    public class DuelGameControlViewModel : GamesControlViewModelBase
    {
        ...
        public DuelGameControlViewModel(UserCurrencyViewModel currency)
        {
        ...
        public DuelGameControlViewModel(DuelGameCommand command)
        {
