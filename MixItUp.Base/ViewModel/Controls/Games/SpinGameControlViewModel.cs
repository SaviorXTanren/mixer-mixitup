...
namespace MixItUp.Base.ViewModel.Controls.Games
{
    ...
    public class SpinGameControlViewModel : GamesControlViewModelBase
    {
        ...
        public SpinGameControlViewModel(UserCurrencyViewModel currency)
        {
        ...
        public SpinGameControlViewModel(SpinGameCommand command)
        {
        ...
        private SpinGameControlViewModel()
        {
