...
{
    public class StealGameControlViewModel : GamesControlViewModelBase
    {
        ...
        public StealGameControlViewModel(UserCurrencyViewModel currency)
        {
        ...
        public StealGameControlViewModel(StealGameCommand command)
        {
