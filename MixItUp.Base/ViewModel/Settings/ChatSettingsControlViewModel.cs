...
namespace MixItUp.Base.ViewModel.Settings
{
    public class ChatSettingsControlViewModel : UIViewModelBase
    {
        ...
        public ObservableCollection<GenericColorComboBoxSettingsOptionControlViewModel> CustomUsernameColorsList { get; set; } = new ObservableCollection<GenericColorComboBoxSettingsOptionControlViewModel>().EnableSync();
