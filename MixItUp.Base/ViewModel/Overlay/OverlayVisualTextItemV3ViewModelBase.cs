...
{
    public abstract class OverlayVisualTextItemV3ViewModelBase : OverlayItemV3ViewModelBase
    {
        public string Text
        {
        ...
        public OverlayVisualTextItemV3ViewModelBase(OverlayItemV3Type type)
            : base(type)
        {
            this.FontSize = 24;
            this.FontName = "Arial";
        ...
        public OverlayVisualTextItemV3ViewModelBase(OverlayVisualTextItemV3ModelBase item)
            : base(item)
        {
            this.Text = item.Text;
