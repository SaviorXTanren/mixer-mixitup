...
namespace MixItUp.Base.ViewModel.Overlay
{
    ...
    {
        public OverlayPositionV3Type PositionType
        {
        ...
        private OverlayPositionV3Type positionType;

        public bool IsSimplePosition
        {
            get
            {
                return this.positionType == OverlayPositionV3Type.Percentage && this.Layer == 0 &&
                    (this.Horizontal == 25 || this.Horizontal == 50 || this.Horizontal == 75) &&
                    (this.Vertical == 25 || this.Vertical == 50 || this.Vertical == 75);
            }
        }
        public bool IsPercentagePosition { get { return !this.IsSimplePosition && this.positionType == OverlayPositionV3Type.Percentage; } }
        public bool IsPixelPosition { get { return this.positionType == OverlayPositionV3Type.Pixel; } }

        public bool IsTopLeftSimplePosition { get { return (this.positionType == OverlayPositionV3Type.Percentage && this.Horizontal == 25 && this.Vertical == 25); } }
        public bool IsTopMiddleSimplePosition { get { return (this.positionType == OverlayPositionV3Type.Percentage && this.Horizontal == 50 && this.Vertical == 25); } }
        public bool IsTopRightSimplePosition { get { return (this.positionType == OverlayPositionV3Type.Percentage && this.Horizontal == 75 && this.Vertical == 25); } }
        public bool IsMiddleLeftSimplePosition { get { return (this.positionType == OverlayPositionV3Type.Percentage && this.Horizontal == 25 && this.Vertical == 50); } }
        public bool IsMiddleMiddleSimplePosition { get { return (this.positionType == OverlayPositionV3Type.Percentage && this.Horizontal == 50 && this.Vertical == 50); } }
        public bool IsMiddleRightSimplePosition { get { return (this.positionType == OverlayPositionV3Type.Percentage && this.Horizontal == 75 && this.Vertical == 50); } }
        public bool IsBottomLeftSimplePosition { get { return (this.positionType == OverlayPositionV3Type.Percentage && this.Horizontal == 25 && this.Vertical == 75); } }
        public bool IsBottomMiddleSimplePosition { get { return (this.positionType == OverlayPositionV3Type.Percentage && this.Horizontal == 50 && this.Vertical == 75); } }
        public bool IsBottomRightSimplePosition { get { return (this.positionType == OverlayPositionV3Type.Percentage && this.Horizontal == 75 && this.Vertical == 75); } }
        ...
        public OverlayPositionV3ViewModel()
        {
            ...
            this.PositionType = OverlayPositionV3Type.Percentage;
            this.Horizontal = 50;
            this.Vertical = 50;
        }

        public OverlayPositionV3ViewModel(OverlayItemV3ModelBase position)
            : this()
        {
            this.SetCommands();

            this.PositionType = position.IsPercentagePosition ? OverlayPositionV3Type.Percentage : OverlayPositionV3Type.Pixel;
        ...
        {
            position.IsPercentagePosition = this.PositionType == OverlayPositionV3Type.Percentage;
