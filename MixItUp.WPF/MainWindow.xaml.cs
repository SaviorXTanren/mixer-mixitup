    ...
    public partial class MainWindow : LoadingWindowBase
    {
        ...
        protected override async Task OnLoaded()
        {
            ...
            if (ChannelSession.Settings.IsStreamer)
            {
                ...
                await this.MainMenu.AddMenuItem("Currency/Rank/Inventory", new CurrencyRankInventoryControl(), "https://github.com/SaviorXTanren/mixer-mixitup/wiki/Currency-&-Rank");
