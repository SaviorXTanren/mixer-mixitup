...
namespace MixItUp.WPF.Controls.Dialogs
{
    ...
    public partial class InteractiveJoystickSetupTestDialogControl : UserControl
    {
        ...
        private async void InteractiveJoystickSetupTestDialogControl_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            await this.command.Perform(ChannelSession.GetCurrentUser(), StreamingPlatformTypeEnum.Mixer, new List<string>() { "0.0", "-1.0" });
            ...
            await this.command.Perform(ChannelSession.GetCurrentUser(), StreamingPlatformTypeEnum.Mixer, new List<string>() { "-1.0", "0.0" });
            await Task.Delay(2500);
            ...
            await this.command.Perform(ChannelSession.GetCurrentUser(), StreamingPlatformTypeEnum.Mixer, new List<string>() { "0.0", "0.0" });
        }
    }
}
