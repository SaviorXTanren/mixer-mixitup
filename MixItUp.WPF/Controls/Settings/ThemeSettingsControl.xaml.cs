...
namespace MixItUp.WPF.Controls.Settings
{
    ...
    public partial class ThemeSettingsControl : SettingsControlBase
    {
        ...
        private Dictionary<string, string> availableFullThemes = new Dictionary<string, string>() { { MixItUp.Base.Resources.None, string.Empty }, { "1 Year Anniversary", "1YearAnniversary" },
            { "Mixer", "Mixer" }, { "Twitch", "Twitch" }, { "AwkwardTyson - Americana", "AwkwardTysonAmericana" }, { "Azhtral's Cosmic Fire" , "AzhtralsCosmicFire" },
            { "Dusty's Purple Potion", "DustysPurplePotion" }, { "Insert Coin Theater", "InsertCoinTheater" }, { "Nibbles' Carrot Patch", "NibblesCarrotPatch" },
            { "Stark Contrast", "StarkContrast" }, { "Tacos After Dark", "TacosAfterDark" }, { "Team Boom", "TeamBoom" } };
