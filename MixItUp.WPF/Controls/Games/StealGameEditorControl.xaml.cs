    ...
    public partial class StealGameEditorControl : GameEditorControlBase
    {
        ...
        protected override Task OnLoaded()
        {
            if (this.existingCommand != null)
            {
                ...
                this.UserPercentageTextBox.Text = this.existingCommand.StealSuccessfulOutcome.RoleProbabilities[MixerRoleEnum.User].ToString();
                this.SubscriberPercentageTextBox.Text = this.existingCommand.StealSuccessfulOutcome.RoleProbabilities[MixerRoleEnum.Subscriber].ToString();
                this.ModPercentageTextBox.Text = this.existingCommand.StealSuccessfulOutcome.RoleProbabilities[MixerRoleEnum.Mod].ToString();
                this.successOutcomeCommand = this.existingCommand.StealSuccessfulOutcome.Command;
                this.failOutcomeCommand = this.existingCommand.StealFailedOutcome.Command;
            }
            else
            {
