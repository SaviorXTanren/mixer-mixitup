namespace Loupedeck.MixItUp3Plugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MixItUp3Plugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MixItUp3Plugin.Resources.Resource.txt`.
